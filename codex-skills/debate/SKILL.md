...
source: skills/debate.md
---

## Codex Adapter Note

This skill is generated from `skills/debate.md` for Codex compatibility.
...
__AITRADING_HOME__/.venv/bin/python __AITRADING_HOME__/tools/news_fetch.py $ARGUMENTS --limit 8 --json
```
所有论点必须由真实数据支撑，禁止编造。
